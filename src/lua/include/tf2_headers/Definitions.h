#if !defined(IncDefinitions_Included)
#define IncDefinitions_Included
...
typedef enum Collision_Group_t
{
...
typedef struct CThreadMutex CThreadMutex;
typedef CThreadMutex CSourceMutex;

typedef enum EHitboxes
{
	HITBOX_HEAD,
	HITBOX_PELVIS,
	HITBOX_SPINE0,
...
typedef enum EZombie128Hitboxes
{
...
typedef enum minigun_weapontypes_t
{
	MINIGUN_STANDARD = 0,
	MINIGUN_STUN
} minigun_weapontypes_t;
...
typedef enum medigun_weapontypes_t
{
	MEDIGUN_STANDARD = 0,
	MEDIGUN_UBER,
	MEDIGUN_QUICKFIX,
	MEDIGUN_RESIST
} medigun_weapontypes_t;

typedef enum RifleTypes_t
{
	RIFLE_NORMAL = 0,
	RIFLE_JARATE,
	RIFLE_MACHINA,
...
typedef enum medigun_resist_types_t
{
	MEDIGUN_BULLET_RESIST = 0,
	MEDIGUN_BLAST_RESIST,
	MEDIGUN_FIRE_RESIST,
	MEDIGUN_NUM_RESISTS
} medigun_resist_types_t;

typedef enum DetonateTypes_t
{
...
typedef enum PrecipitationType_t
{
...
typedef struct CViewVectors CViewVectors;
...
typedef struct CUtlString CUtlString;
...
typedef struct FireBulletsInfo_t FireBulletsInfo_t;
...
typedef struct CHudTexture CHudTexture;
...
typedef enum ETFClassID
{
	ID_CTFWearableRazorback = 341,
	ID_CTFWearableDemoShield = 338,
	ID_CTFWearableLevelableItem = 340,
	ID_CTFWearableCampaignItem = 337,
	ID_CTFBaseRocket = 185,
	ID_CTFWeaponBaseMerasmusGrenade = 325,
	ID_CTFWeaponBaseMelee = 324,
	ID_CTFWeaponBaseGun = 323,
	ID_CTFWeaponBaseGrenadeProj = 322,
	ID_CTFWeaponBase = 321,
	ID_CTFWearableRobotArm = 342,
	ID_CTFRobotArm = 287,
	ID_CTFWrench = 344,
	ID_CTFProjectile_ThrowableBreadMonster = 279,
	ID_CTFProjectile_ThrowableBrick = 280,
	ID_CTFProjectile_ThrowableRepel = 281,
	ID_CTFProjectile_Throwable = 278,
	ID_CTFThrowable = 319,
	ID_CTFSyringeGun = 315,
	ID_CTFKatana = 225,
	ID_CTFSword = 314,
	ID_CSniperDot = 118,
	ID_CTFSniperRifleClassic = 308,
	ID_CTFSniperRifleDecap = 309,
	ID_CTFSniperRifle = 307,
	ID_CTFChargedSMG = 197,
	ID_CTFSMG = 306,
	ID_CTFSlap = 305,
	ID_CTFShovel = 304,
	ID_CTFShotgunBuildingRescue = 303,
	ID_CTFPEPBrawlerBlaster = 241,
	ID_CTFSodaPopper = 310,
	ID_CTFShotgun_Revenge = 301,
	ID_CTFScatterGun = 297,
	ID_CTFShotgun_Pyro = 300,
	ID_CTFShotgun_HWG = 299,
	ID_CTFShotgun_Soldier = 302,
	ID_CTFShotgun = 298,
	ID_CTFRocketPack = 296,
	ID_CTFCrossbow = 201,
	ID_CTFRocketLauncher_Mortar = 295,
	ID_CTFRocketLauncher_AirStrike = 293,
	ID_CTFRocketLauncher_DirectHit = 294,
	ID_CTFRocketLauncher = 292,
	ID_CTFRevolver = 286,
	ID_CTFDRGPomson = 202,
	ID_CTFRaygun = 284,
	ID_CTFPistol_ScoutSecondary = 246,
	ID_CTFPistol_ScoutPrimary = 245,
	ID_CTFPistol_Scout = 244,
	ID_CTFPistol = 243,
	ID_CTFPipebombLauncher = 242,
	ID_CTFWeaponPDA_Spy = 332,
	ID_CTFWeaponPDA_Engineer_Destroy = 331,
	ID_CTFWeaponPDA_Engineer_Build = 330,
	ID_CTFWeaponPDAExpansion_Teleporter = 334,
	ID_CTFWeaponPDAExpansion_Dispenser = 333,
	ID_CTFWeaponPDA = 329,
	ID_CTFParticleCannon = 239,
	ID_CTFParachute_Secondary = 238,
	ID_CTFParachute_Primary = 237,
	ID_CTFParachute = 236,
	ID_CTFMinigun = 234,
	ID_CTFMedigunShield = 231,
	ID_CWeaponMedigun = 352,
	ID_CTFProjectile_MechanicalArmOrb = 263,
	ID_CTFMechanicalArm = 230,
	ID_CTFLunchBox_Drink = 229,
	ID_CTFLunchBox = 228,
	ID_CLaserDot = 78,
	ID_CTFLaserPointer = 227,
	ID_CTFKnife = 226,
	ID_CTFGasManager = 212,
	ID_CTFProjectile_JarGas = 261,
	ID_CTFJarGas = 223,
	ID_CTFProjectile_Cleaver = 254,
	ID_CTFProjectile_JarMilk = 262,
	ID_CTFProjectile_Jar = 260,
	ID_CTFCleaver = 198,
	ID_CTFJarMilk = 224,
	ID_CTFJar = 222,
	ID_CTFWeaponInvis = 328,
	ID_CTFCannon = 196,
	ID_CTFGrenadeLauncher = 216,
	ID_CTFGrenadePipebombProjectile = 217,
	ID_CTFGrapplingHook = 215,
	ID_CTFFlareGun_Revenge = 210,
	ID_CTFFlareGun = 209,
	ID_CTFFlameRocket = 207,
	ID_CTFFlameThrower = 208,
	ID_CTFFists = 205,
	ID_CTFFireAxe = 204,
	ID_CTFWeaponFlameBall = 327,
	ID_CTFCompoundBow = 200,
	ID_CTFClub = 199,
	ID_CTFBuffItem = 195,
	ID_CTFStickBomb = 312,
	ID_CTFBreakableSign = 194,
	ID_CTFBottle = 192,
	ID_CTFBreakableMelee = 193,
	ID_CTFBonesaw = 190,
	ID_CTFBall_Ornament = 182,
	ID_CTFStunBall = 313,
	ID_CTFBat_Giftwrap = 188,
	ID_CTFBat_Wood = 189,
	ID_CTFBat_Fish = 187,
	ID_CTFBat = 186,
	ID_CTFProjectile_EnergyRing = 256,
	ID_CTFDroppedWeapon = 203,
	ID_CTFWeaponSapper = 335,
	ID_CTFWeaponBuilder = 326,
	ID_C_TFWeaponBuilder = 0,
	ID_CTFProjectile_Rocket = 264,
	ID_CTFProjectile_Flare = 257,
	ID_CTFProjectile_EnergyBall = 255,
	ID_CTFProjectile_GrapplingHook = 258,
	ID_CTFProjectile_HealingBolt = 259,
	ID_CTFProjectile_Arrow = 252,
	ID_CMannVsMachineStats = 80,
	ID_CTFTankBoss = 316,
	ID_CTFBaseBoss = 183,
	ID_CBossAlpha = 0,
	ID_NextBotCombatCharacter = 357,
	ID_CTFProjectile_SpellKartBats = 268,
	ID_CTFProjectile_SpellKartOrb = 269,
	ID_CTFHellZap = 220,
	ID_CTFProjectile_SpellLightningOrb = 270,
	ID_CTFProjectile_SpellTransposeTeleport = 277,
	ID_CTFProjectile_SpellMeteorShower = 271,
	ID_CTFProjectile_SpellSpawnBoss = 274,
	ID_CTFProjectile_SpellMirv = 272,
	ID_CTFProjectile_SpellPumpkin = 273,
	ID_CTFProjectile_SpellSpawnHorde = 275,
	ID_CTFProjectile_SpellSpawnZombie = 276,
	ID_CTFProjectile_SpellBats = 266,
	ID_CTFProjectile_SpellFireball = 267,
	ID_CTFSpellBook = 311,
	ID_CHightower_TeleportVortex = 74,
	ID_CTeleportVortex = 160,
	ID_CZombie = 354,
	ID_CMerasmusDancer = 83,
	ID_CMerasmus = 82,
	ID_CHeadlessHatman = 73,
	ID_CEyeballBoss = 48,
	ID_CTFBotHintEngineerNest = 191,
	ID_CBotNPCMinion = 0,
	ID_CBotNPC = 0,
	ID_CPasstimeGun = 94,
	ID_CTFViewModel = 320,
	ID_CRobotDispenser = 112,
	ID_CTFRobotDestruction_Robot = 288,
	ID_CTFReviveMarker = 285,
	ID_CTFPumpkinBomb = 282,
	ID_CTFProjectile_BallOfFire = 253,
	ID_CTFBaseProjectile = 184,
	ID_CTFPointManager = 250,
	ID_CBaseObjectUpgrade = 11,
	ID_CTFRobotDestructionLogic = 291,
	ID_CTFRobotDestruction_RobotGroup = 289,
	ID_CTFRobotDestruction_RobotSpawn = 290,
	ID_CTFPlayerDestructionLogic = 248,
	ID_CPlayerDestructionDispenser = 101,
	ID_CTFMinigameLogic = 233,
	ID_CTFHalloweenMinigame_FallingPlatforms = 219,
	ID_CTFHalloweenMinigame = 218,
	ID_CTFMiniGame = 232,
	ID_CTFPowerupBottle = 251,
	ID_CTFItem = 221,
	ID_CHalloweenSoulPack = 71,
	ID_CTFGenericBomb = 213,
	ID_CBonusRoundLogic = 23,
	ID_CTFGameRulesProxy = 211,
	ID_CTETFParticleEffect = 179,
	ID_CTETFExplosion = 178,
	ID_CTETFBlood = 177,
	ID_CTFFlameManager = 206,
	ID_CHalloweenGiftPickup = 69,
	ID_CBonusDuckPickup = 21,
	ID_CHalloweenPickup = 70,
	ID_CCaptureFlagReturnIcon = 27,
	ID_CCaptureFlag = 26,
	ID_CBonusPack = 22,
	ID_CTFTeam = 318,
	ID_CTFTauntProp = 317,
	ID_CTFPlayerResource = 249,
	ID_CTFPlayer = 247,
	ID_CTFRagdoll = 283,
	ID_CTEPlayerAnimEvent = 165,
	ID_CTFPasstimeLogic = 240,
	ID_CPasstimeBall = 93,
	ID_CTFObjectiveResource = 235,
	ID_CTFGlow = 214,
	ID_CTEFireBullets = 152,
	ID_CTFBuffBanner = 0,
	ID_CTFAmmoPack = 181,
	ID_CObjectTeleporter = 89,
	ID_CObjectSentrygun = 88,
	ID_CTFProjectile_SentryRocket = 265,
	ID_CObjectSapper = 87,
	ID_CObjectCartDispenser = 85,
	ID_CObjectDispenser = 86,
	ID_CMonsterResource = 84,
	ID_CFuncRespawnRoomVisualizer = 64,
	ID_CFuncRespawnRoom = 63,
	ID_CFuncPasstimeGoal = 61,
	ID_CFuncForceField = 57,
	ID_CCaptureZone = 28,
	ID_CCurrencyPack = 31,
	ID_CBaseObject = 10,
	ID_CTestTraceline = 176,
	ID_CTEWorldDecal = 180,
	ID_CTESpriteSpray = 174,
	ID_CTESprite = 173,
	ID_CTESparks = 172,
	ID_CTESmoke = 171,
	ID_CTEShowLine = 169,
	ID_CTEProjectedDecal = 167,
	ID_CTEPlayerDecal = 166,
	ID_CTEPhysicsProp = 164,
	ID_CTEParticleSystem = 163,
	ID_CTEMuzzleFlash = 162,
	ID_CTELargeFunnel = 159,
	ID_CTEKillPlayerAttachments = 158,
	ID_CTEImpact = 157,
	ID_CTEGlowSprite = 156,
	ID_CTEShatterSurface = 168,
	ID_CTEFootprintDecal = 154,
	ID_CTEFizz = 153,
	ID_CTEExplosion = 151,
	ID_CTEEnergySplash = 150,
	ID_CTEEffectDispatch = 149,
	ID_CTEDynamicLight = 148,
	ID_CTEDecal = 146,
	ID_CTEClientProjectile = 145,
	ID_CTEBubbleTrail = 144,
	ID_CTEBubbles = 143,
	ID_CTEBSPDecal = 142,
	ID_CTEBreakModel = 141,
	ID_CTEBloodStream = 140,
	ID_CTEBloodSprite = 139,
	ID_CTEBeamSpline = 138,
	ID_CTEBeamRingPoint = 137,
	ID_CTEBeamRing = 136,
	ID_CTEBeamPoints = 135,
	ID_CTEBeamLaser = 134,
	ID_CTEBeamFollow = 133,
	ID_CTEBeamEnts = 132,
	ID_CTEBeamEntPoint = 131,
	ID_CTEBaseBeam = 130,
	ID_CTEArmorRicochet = 129,
	ID_CTEMetalSparks = 161,
	ID_CSteamJet = 123,
	ID_CSmokeStack = 117,
	ID_DustTrail = 355,
	ID_CFireTrail = 50,
	ID_SporeTrail = 362,
	ID_SporeExplosion = 361,
	ID_RocketTrail = 359,
	ID_SmokeTrail = 360,
	ID_CPropVehicleDriveable = 108,
	ID_ParticleSmokeGrenade = 358,
	ID_CParticleFire = 90,
	ID_MovieExplosion = 356,
	ID_CTEGaussExplosion = 155,
	ID_CEnvQuadraticBeam = 43,
	ID_CEmbers = 36,
	ID_CEnvWind = 47,
	ID_CPrecipitation = 107,
	ID_CBaseTempEntity = 17,
	ID_CWeaponIFMSteadyCam = 351,
	ID_CWeaponIFMBaseCamera = 350,
	ID_CWeaponIFMBase = 349,
	ID_CTFWearableVM = 343,
	ID_CTFWearable = 336,
	ID_CTFWearableItem = 339,
	ID_CEconWearable = 35,
	ID_CBaseAttributableItem = 3,
	ID_CEconEntity = 34,
	ID_CHandleTest = 72,
	ID_CTeamplayRoundBasedRulesProxy = 126,
	ID_CTeamRoundTimer = 127,
	ID_CSpriteTrail = 122,
	ID_CSpriteOriented = 121,
	ID_CSprite = 120,
	ID_CRagdollPropAttached = 111,
	ID_CRagdollProp = 110,
	ID_CPoseController = 106,
	ID_CGameRulesProxy = 68,
	ID_CInfoLadderDismount = 75,
	ID_CFuncLadder = 58,
	ID_CEnvDetailController = 40,
	ID_CWorld = 353,
	ID_CWaterLODControl = 348,
	ID_CWaterBullet = 347,
	ID_CVoteController = 346,
	ID_CVGuiScreen = 345,
	ID_CPropJeep = 0,
	ID_CPropVehicleChoreoGeneric = 0,
	ID_CTest_ProxyToggle_Networkable = 175,
	ID_CTesla = 170,
	ID_CTeamTrainWatcher = 128,
	ID_CBaseTeamObjectiveResource = 16,
	ID_CTeam = 125,
	ID_CSun = 124,
	ID_CParticlePerformanceMonitor = 91,
	ID_CSpotlightEnd = 119,
	ID_CSlideshowDisplay = 116,
	ID_CShadowControl = 115,
	ID_CSceneEntity = 114,
	ID_CRopeKeyframe = 113,
	ID_CRagdollManager = 109,
	ID_CPhysicsPropMultiplayer = 98,
	ID_CPhysBoxMultiplayer = 96,
	ID_CBasePropDoor = 15,
	ID_CDynamicProp = 33,
	ID_CPointWorldText = 105,
	ID_CPointCommentaryNode = 104,
	ID_CPointCamera = 103,
	ID_CPlayerResource = 102,
	ID_CPlasma = 100,
	ID_CPhysMagnet = 99,
	ID_CPhysicsProp = 97,
	ID_CPhysBox = 95,
	ID_CParticleSystem = 92,
	ID_CMaterialModifyControl = 81,
	ID_CLightGlow = 79,
	ID_CInfoOverlayAccessor = 77,
	ID_CFuncTrackTrain = 67,
	ID_CFuncSmokeVolume = 66,
	ID_CFuncRotating = 65,
	ID_CFuncReflectiveGlass = 62,
	ID_CFuncOccluder = 60,
	ID_CFuncMonitor = 59,
	ID_CFunc_LOD = 54,
	ID_CTEDust = 147,
	ID_CFunc_Dust = 53,
	ID_CFuncConveyor = 56,
	ID_CBreakableSurface = 25,
	ID_CFuncAreaPortalWindow = 55,
	ID_CFish = 51,
	ID_CEntityFlame = 38,
	ID_CFireSmoke = 49,
	ID_CEnvTonemapController = 46,
	ID_CEnvScreenEffect = 44,
	ID_CEnvScreenOverlay = 45,
	ID_CEnvProjectedTexture = 42,
	ID_CEnvParticleScript = 41,
	ID_CFogController = 52,
	ID_CEntityParticleTrail = 39,
	ID_CEntityDissolve = 37,
	ID_CDynamicLight = 32,
	ID_CColorCorrectionVolume = 30,
	ID_CColorCorrection = 29,
	ID_CBreakableProp = 24,
	ID_CBasePlayer = 13,
	ID_CBaseFlex = 8,
	ID_CBaseEntity = 7,
	ID_CBaseDoor = 6,
	ID_CBaseCombatCharacter = 4,
	ID_CBaseAnimatingOverlay = 2,
	ID_CBoneFollower = 20,
	ID_CBaseAnimating = 1,
	ID_CInfoLightingRelative = 76,
	ID_CAI_BaseNPC = 0,
	ID_CBeam = 19,
	ID_CBaseViewModel = 18,
	ID_CBaseProjectile = 14,
	ID_CBaseParticleEntity = 12,
	ID_CBaseGrenade = 9,
	ID_CBaseCombatWeapon = 5
} ETFClassID;
...
typedef enum MedigunChargeTypes
{
...
typedef enum HalloweenBossType
{
...
typedef enum PowerupBottleType_t
{
	POWERUP_BOTTLE_NONE,
...
typedef enum gamerules_roundstate_t
{
...
typedef enum ETFFlagEventTypes
{
...
typedef enum CurrencyRewards_t
{
...
typedef enum MVMAnnouncement_t
{
...
typedef enum MVMUpgradeUIGroups_t
{
...
typedef struct CSfxTable CSfxTable;

typedef struct CSfxTable_VMT
{
	const char* (*getname)(CSfxTable*);
} CSfxTable_VMT;
...
typedef struct StartSoundParams_t
{
	bool staticsound;
	int userdata;
	int soundsource;
